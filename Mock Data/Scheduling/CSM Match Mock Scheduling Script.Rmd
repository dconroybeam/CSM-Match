...
randLink<-"ucsb.qualtrics.com/test?cond=s&id="
matchLink<-"ucsb.qualtrics.com/test?cond=r&id="
...
times<-gsub("_1","",colnames(participant)[seq(4,115,7)])
...
blocks<-melt(participant,id.vars=c("PIN","match","sex"),
         variable.name="time",
         value.name="avail")
...
#Remove any timeslots that are not a block for blockss
