...
accRecord <- as.data.frame(matrix(NA, loops, numPrefs + 3))
colnames(accRecord) <- c("loop","numPrefs",paste0("pref", 1:numPrefs), "acc")
...
#Save winning preferences and accuracy across loops
write.csv(accRecord, "Model Outputs/CSM Match Pref Modeling ACC Record.csv")
