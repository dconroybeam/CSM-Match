...
data<-read.csv("human-data/raw-data/CSM Match F24 Prescreen Data Raw.csv")

#Load in PINS of people who completed the scheduling survey
sPINs<-read.csv("human-data/raw-data/CSM Match F24 Scheduling Data PINs.csv")
...
data<-data[rowSums(is.na(selfComp))<15 & rowSums(is.na(idealComp))<15,]

#Save data
write.csv(data,"human-data/processed-data/CSM-Match-matching-data-F24.csv",
          row.names=F)
