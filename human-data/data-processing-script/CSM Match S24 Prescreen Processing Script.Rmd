...
data<-read.csv("human-data/raw-data/CSM Match S24 Prescreen Data Raw.csv")

#Load in PINS of people who completed the scheduling survey
sPINs<-read.csv("human-data/raw-data/CSM Match S24 Scheduling Data PINs.csv")
...
#Save data
write.csv(data,"human-data/processed-data/CSM-Match-matching-data-S24.csv",
          row.names=F)
